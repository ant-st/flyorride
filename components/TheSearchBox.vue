            ...
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <div class="flex flex-row justify-between space-x-4">
                <div class="flex flex-col" >
                  ...
                  <input type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Start">
                </div>
                <div class="flex flex-col justify-end" >
                  <label class="leading-loose">Lotniska:</label>
                  <input type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Lotniska">
                </div>
                <div class="flex flex-col">
                  <label class="leading-loose">Cel podróży:</label>
                  <input type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Cel">
                </div>
              </div>
              ...
              <div class="flex flex-row justify-between items-center space-x-4">
                <div class="flex flex-col w-1/3 items-between">
                  ...
                  <div class="relative focus-within:text-gray-600 text-gray-400 w-full">
                    <input type="date" class="sm:pr-4 sm:pl-10 px-2 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="25/02/2020">
                ...
                <div class="flex flex-col w-1/3 items-between">
                  ...
                  <div class="relative focus-within:text-gray-600 text-gray-400 w-full">
                    <input type="date" class="sm:pr-4 sm:pl-10 px-2 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="26/02/2020">
                    <div class="hidden sm:block absolute left-3 top-2">
                      <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
                  </div>
                ...
                <div class="flex flex-col w-1/3 items-between">
                  ...
                  <div class="relative focus-within:text-gray-600 text-gray-400 w-full max-w-[155px]">
                    <input type="number" min=1 class="sm:pr-4 sm:pl-10 px-2 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                    <div class="hidden sm:block absolute left-3 top-2">
                      ...
                      <transition name="transform-fade-down">
                        ...
                        >
                          <li v-for="option in searchOptions">
                            <label>
                              <input type="checkbox" value="option.value" class="mx-2"> {{option.name}}
                            </label>
                          </li>
                        </ul>
                      </transition>
